...
public class Funcoes {
    ...
    public void cadastrarCurso(Programa programa,int numCurso,String nomeCurso)throws NumberFormatException{
        // Cadastrar curso
    ...
    public void cadastrarAvaliacao(Programa programa,String codDis,String nome, String codAva,String tipo,Date data,int peso,int max)throws NumberFormatException,ParseException{
        // Cadastrar prova
    ...
    public void cadastrarAluno(Programa programa,Double codMat,String cursoAluno,String nome,String tipo){
        // Cadastrar aluno(a)
        Curso curso;
    ...
    public void matricularAlunoDisciplina(Programa programa, Scanner sc){
        ...
        if(aux==1){
            ...
            double matAluno = Double.parseDouble(sc.nextLine());
...
*/
    ...
    public void imprimirDados(Programa programa){
        System.out.println("Disciplinas e alunos matriculados:");
                ...
                for (Map.Entry<String, Disciplina> me : programa.getDisciplinas().entrySet()) {
                    ...
                    for(Map.Entry<Double, Aluno> mapaAluno : me.getValue().getListAluno().entrySet()){
    ...
    public Programa carregarArquivos()throws ClassNotFoundException,IOException{
    ...
    public void relatorioF(Programa programa){//relatorio final
        ...
        for (Map.Entry<String, Disciplina> dis : programa.getDisciplinas().entrySet()){
                        ...
                        for (Map.Entry<Double, Aluno> me : disciplina.getListAluno().entrySet()) {
                            ...
                            for(Map.Entry<String,Avaliacao> pro: disciplina.getListAvaliacoes().entrySet()){
                                prova=pro.getValue();
